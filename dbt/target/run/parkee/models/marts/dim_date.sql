        ...
        insert into `analytics_marts`.`dim_date__dbt_backup`
        ("date_id", "date", "year", "quarter", "month", "month_name", "day_of_month", "day_of_week", "day_name", "iso_week", "is_weekend")with date_bounds as (
    select
